...
#ifndef DRAGONFLY_VALIANT_ROUTING_H
#define DRAGONFLY_VALIANT_ROUTING_H
...
class DragonflyValiantRouting : public Ipv4RoutingProtocol
{
  public:
    static TypeId GetTypeId();

    DragonflyValiantRouting();
    DragonflyValiantRouting(Ptr<Node> node, Ptr<StructuredTopology> topo);
    ~DragonflyValiantRouting() override;
...
#endif // DRAGONFLY_VALIANT_ROUTING_H
